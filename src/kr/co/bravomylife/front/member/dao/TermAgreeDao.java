 ...
 *				: [20241001130725][whslsl88#gmail.com][CREATE: Initial Release]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("kr.co.bravomylife.front.member.dao.TermAgreeDao")
public class TermAgreeDao extends BaseDao {
	
	public int sequence() {
		return sqlSessionFront.selectOne("kr.co.bravomylife.front.mybatis.member.TermAgree.sequence");
	}

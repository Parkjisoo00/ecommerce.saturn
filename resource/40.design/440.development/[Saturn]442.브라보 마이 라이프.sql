...
COMMENT ON COLUMN "TB_PRD"."CD_CTG_B" IS '상품 카테고리 : 1(기능별), 2(성분별), 3(대상별)';

COMMENT ON COLUMN "TB_PRD"."CD_CTG_M" IS '상품 카테고리 중분류 : 1-9';

COMMENT ON COLUMN "TB_PRD"."PRD_TYPE" IS '상품 제품 타입 : 1(액상), 2(정), 3(캡슐), 4(베지캡슐), 5(젤리), 6(분말), 7(츄어블)';

COMMENT ON COLUMN "TB_PRD"."PRICE_COST" IS '상품 원가';

COMMENT ON COLUMN "TB_PRD"."COUNT_STOCK" IS '상품 재고';

COMMENT ON COLUMN "TB_PRD"."FLG_DELETE" IS '삭제 처리 여부 : N(기본값), Y(삭제 처리)';

COMMENT ON COLUMN "TB_PRD"."CD_STATE_PRD" IS '판매 상품 코드: 대기(1), 판매(2), 중지(3), 재고 소진(9)';

COMMENT ON COLUMN "TB_PRD"."CORP_NM" IS '회사명=브랜드명';
...
COMMENT ON COLUMN "TB_MBT_DTL"."SEQ_MBR" IS '회원 일련번호';

COMMENT ON COLUMN "TB_MBT_DTL"."POST" IS '우편번호';

COMMENT ON COLUMN "TB_MBT_DTL"."ADDR1" IS '주소1';

COMMENT ON COLUMN "TB_MBT_DTL"."ADDR2" IS '주소2';

COMMENT ON COLUMN "TB_MBT_DTL"."FLG_SMS" IS '수신 여부 SMS';

COMMENT ON COLUMN "TB_MBT_DTL"."FLG_EMAIL" IS '수신 여부 EMAIL';

COMMENT ON COLUMN "TB_MBT_DTL"."DT_SMS" IS '수신 여부 SMS 일시';

COMMENT ON COLUMN "TB_MBT_DTL"."DT_EMAIL" IS '수신 여부 EMAIL 일시';

COMMENT ON COLUMN "TB_MBT_DTL"."DT_UPT" IS '수정 일시';

COMMENT ON COLUMN "TB_MBT_DTL"."UPDATER" IS '수정자';

CREATE TABLE "TB_TRM_AGR" (
	"SRQ_TRM_AGR"	NUMBER(19)		NOT NULL,
	"SEQ_MBR"	NUMBER(10)		NOT NULL,
...
COMMENT ON COLUMN "TB_TRM_AGR"."SRQ_TRM_AGR" IS '약관 동의 일련번호';
...
CREATE TABLE "TB_HP_SUR" (
	...
	"AGE"	NUMBER(3)		NOT NULL,
	"GENDER"	CHAR(1)		NOT NULL,
	"FUNCTION1"	CHAR(1)		NOT NULL,
	"FUNCTION2"	CHAR(1)		NOT NULL,
	"FUNCTION3"	CHAR(1)		NOT NULL,
	"FUNCTION4"	CHAR(1)		NOT NULL,
	"FUNCTION5"	CHAR(1)		NOT NULL,
	"FUNCTION6"	CHAR(1)		NOT NULL,
	"FUNCTION7"	CHAR(1)		NOT NULL,
	"FUNCTION8"	CHAR(1)		NOT NULL,
	"FUNCTION9"	CHAR(1)		NOT NULL,
	"NOT_EAT1"	CHAR(1)		NOT NULL,
	"NOT_EAT2"	CHAR(1)		NOT NULL,
	"NOT_EAT3"	CHAR(1)		NOT NULL,
	"NOT_EAT4"	CHAR(1)		NOT NULL,
	"NOT_EAT5"	CHAR(1)		NOT NULL,
	"NOT_EAT6"	CHAR(1)		NOT NULL,
	"NOT_EAT7"	CHAR(1)		NOT NULL,
	"NOT_EAT8"	CHAR(1)		NOT NULL,
	"NOT_EAT9"	CHAR(1)		NOT NULL,
	"REGISTER"	NUMBER(10)		NOT NULL,
	"DT_REG"	DATE		NOT NULL,
	"DT_UPT"	DATE		NULL,
	"UPDATER"	NUMBER(10)		NULL
...
COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION1" IS '1:혈당/혈행/혈압';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION2" IS '2:황산화/면연력';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION3" IS '3:염증/항염';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION4" IS '4:관절/뼈/치아';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION5" IS '5:피로회복';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION6" IS '6:눈 건강';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION7" IS '7:장 건강';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION8" IS '8:두뇌/기억력';

COMMENT ON COLUMN "TB_HP_SUR"."FUNCTION9" IS '9:위/간/갑상선';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT1" IS '1:폴리코사놀';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT2" IS '2:오메가3/6/9';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT3" IS '3:비타민/미네랄';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT4" IS '4:유산균';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT5" IS '5:글루코사민/MSM';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT6" IS '6:루테인';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT7" IS '7:코큐텐';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT8" IS '8:아르기닌';

COMMENT ON COLUMN "TB_HP_SUR"."NOT_EAT9" IS '9:밀크씨슬';
...
CREATE TABLE "TB_HP_SUR_MBR" (
	"SEQ_MBR"	NUMBER(10)		NOT NULL,
	"AGE"	NUMBER(10)		NOT NULL,
	"GENDER"	CHAR(1)		NOT NULL
);

COMMENT ON COLUMN "TB_HP_SUR_MBR"."SEQ_MBR" IS '회원 일련번호';

COMMENT ON COLUMN "TB_HP_SUR_MBR"."AGE" IS '나이';

COMMENT ON COLUMN "TB_HP_SUR_MBR"."GENDER" IS '성별 : 남자(M), 여자(F)';
...
COMMENT ON COLUMN "TB_BUY_MST"."FLG_LIKE" IS '찜 표시';

COMMENT ON COLUMN "TB_BUY_MST"."CD_STATE" IS '구매 상품 상태 : 1(취소), 2(교환), 3(환불)';
...
COMMENT ON COLUMN "TB_BBS"."CD_BBS_TYPE" IS '게시판 타입 코드: 공지사항(1), FAQ(2), 고객문의(3)';
...
ALTER TABLE "TB_MBT_DTL" ADD CONSTRAINT "PK_TB_MBT_DTL" PRIMARY KEY (
	"SEQ_MBR"
);
...
ALTER TABLE "TB_HP_SUR_MBR" ADD CONSTRAINT "PK_TB_HP_SUR_MBR" PRIMARY KEY (
	"SEQ_MBR"
);
...
ALTER TABLE "TB_MBT_DTL" ADD CONSTRAINT "FK_TB_MBR_MST_TO_TB_MBT_DTL_1" FOREIGN KEY (
	"SEQ_MBR"
)
...
ALTER TABLE "TB_HP_SUR_MBR" ADD CONSTRAINT "FK_TB_MBR_MST_TO_TB_HP_SUR_MBR_1" FOREIGN KEY (
	"SEQ_MBR"
)
REFERENCES "TB_MBR_MST" (
	"SEQ_MBR"

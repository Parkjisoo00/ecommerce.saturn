...
CREATE TABLE "TB_HP_SUR" (
	...
	"AGE"	NUMBER(3)		NULL,
	"GENDER"	CHAR(1)		NULL,
	"FUNCTION1"	CHAR(1)		NULL,
	"FUNCTION2"	CHAR(1)		NULL,
	"FUNCTION3"	CHAR(1)		NULL,
	"FUNCTION4"	CHAR(1)		NULL,
	"FUNCTION5"	CHAR(1)		NULL,
	"FUNCTION6"	CHAR(1)		NULL,
	"FUNCTION7"	CHAR(1)		NULL,
	"FUNCTION8"	CHAR(1)		NULL,
	"FUNCTION9"	CHAR(1)		NULL,
	"NOT_EAT1"	CHAR(1)		NULL,
	"NOT_EAT2"	CHAR(1)		NULL,
	"NOT_EAT3"	CHAR(1)		NULL,
	"NOT_EAT4"	CHAR(1)		NULL,
	"NOT_EAT5"	CHAR(1)		NULL,
	"NOT_EAT6"	CHAR(1)		NULL,
	"NOT_EAT7"	CHAR(1)		NULL,
	"NOT_EAT8"	CHAR(1)		NULL,
	"NOT_EAT9"	CHAR(1)		NULL,
	"REGISTER"	NUMBER(10)		NOT NULL,
	"DT_REG"	DATE		NOT NULL,
	"DT_UPT"	DATE		NULL,
	"UPDATER"	NUMBER(10)		NULL
...
COMMENT ON COLUMN "TB_HP_SUR"."SEQ_SLE" IS '판매 상품 일련번호';
...
COMMENT ON COLUMN "TB_HP_SUR_MBR"."SEQ_HP_SUR" IS '검사 일련번호';

COMMENT ON COLUMN "TB_HP_SUR_MBR"."SEQ_SLE" IS '판매 상품 일련번호';
...
COMMENT ON COLUMN "TB_BEST"."SEQ_BEST" IS '베스트 상품 일련번호';
...
COMMENT ON COLUMN "TB_BEST"."UPDATER" IS '수정자';

CREATE TABLE "TB_MBR_POINT" (
	"SEQ_MBR"	NUMBER(10)		NOT NULL,
...
COMMENT ON COLUMN "TB_MBR_POINT"."SEQ_MBR" IS '회원 일련번호';

COMMENT ON COLUMN "TB_MBR_POINT"."POINT" IS '포인트';

COMMENT ON COLUMN "TB_MBR_POINT"."DT_REG" IS '등록 일시';

COMMENT ON COLUMN "TB_MBR_POINT"."REGISTER" IS '등록자';

COMMENT ON COLUMN "TB_MBR_POINT"."DT_UPT" IS '수정 일시';

COMMENT ON COLUMN "TB_MBR_POINT"."UPDATER" IS '수정자';
...
ALTER TABLE "TB_MBR_POINT" ADD CONSTRAINT "PK_TB_MBR_POINT" PRIMARY KEY (
	"SEQ_MBR"
);
...
ALTER TABLE "TB_MBR_POINT" ADD CONSTRAINT "FK_TB_MBR_MST_TO_TB_MBR_POINT_1" FOREIGN KEY (
	"SEQ_MBR"
)
REFERENCES "TB_MBR_MST" (
	"SEQ_MBR"

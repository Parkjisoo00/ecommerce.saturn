...
COMMENT ON COLUMN "TB_BUY_DTL"."ADDR1" IS '주소1';

COMMENT ON COLUMN "TB_BUY_DTL"."ADDR2" IS '주소2';

COMMENT ON COLUMN "TB_BUY_DTL"."POST" IS '우편번호';
...
COMMENT ON COLUMN "TB_BUY_DTL"."CD_STATE_DELIVERY" IS '배송 상태 코드: 등록(NULL), 판매 확인중(C), 배송 준비중(P), 배송중(D), 배송 완료(Y)';

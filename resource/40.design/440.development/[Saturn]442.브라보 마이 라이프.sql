...
COMMENT ON COLUMN "TB_MBR_PT"."SEQ_MBR" IS '회원 일련번호';

COMMENT ON COLUMN "TB_MBR_PT"."POINT" IS '포인트';

COMMENT ON COLUMN "TB_MBR_PT"."DT_REG" IS '등록 일시';

COMMENT ON COLUMN "TB_MBR_PT"."REGISTER" IS '등록자';

COMMENT ON COLUMN "TB_MBR_PT"."DT_UPT" IS '수정 일시';

COMMENT ON COLUMN "TB_MBR_PT"."UPDATER" IS '수정자';

CREATE TABLE "TB_RATE" (
	"SEQ_RATE"	NUMBER(10)		NOT NULL,
	"SEQ_SLE"	NUMBER(10)		NOT NULL,
	"COUNT"	NUMBER(10)		NULL,
	"RATE_STAR"	NUMBER(10)		NULL,
	"DT_REG"	DATE		NOT NULL,
	"DT_UPT"	DATE		NULL
);

COMMENT ON COLUMN "TB_RATE"."SEQ_RATE" IS '평점 일련번호';
...
ALTER TABLE "TB_MBR_PT" ADD CONSTRAINT "PK_TB_MBR_PT" PRIMARY KEY (
	"SEQ_MBR"
);
...
ALTER TABLE "TB_MBR_PT" ADD CONSTRAINT "FK_TB_MBR_MST_TO_TB_MBR_PT_1" FOREIGN KEY (
	"SEQ_MBR"
)
REFERENCES "TB_MBR_MST" (
	"SEQ_MBR"

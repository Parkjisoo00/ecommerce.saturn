...
COMMENT ON COLUMN "TB_BUY_DTL"."POINT" IS '포인트';
...
COMMENT ON COLUMN "TB_MBR_PT"."SEQ_SLE" IS '판매 상품 일련번호';

COMMENT ON COLUMN "TB_MBR_PT"."POINT" IS '포인트';

COMMENT ON COLUMN "TB_MBR_PT"."TOTAL_POINT" IS '포인트 총합';
...
COMMENT ON COLUMN "TB_REVIEW"."IMG" IS '이미지';

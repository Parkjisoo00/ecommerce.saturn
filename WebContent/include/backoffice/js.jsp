<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" trimDirectiveWhitespaces="true" %>
	<script src="/backoffice/js/jquery-2.2.3.min.js"></script>
	...
	<script src="/backoffice/js/jquery.knob.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
	<script src="/backoffice/js/daterangepicker.js"></script>
	<script src="/backoffice/js/bootstrap-datepicker.js"></script>

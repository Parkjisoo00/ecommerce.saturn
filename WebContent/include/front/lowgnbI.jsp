...
<div class="col-lg-12" style="padding: 0 !important;">
	...
	<h6 class="coupon__link" style="text-align: left; letter-spacing: 1.5px;">
		...
		<c:when test="${paging.filter == '' && paging.corp_nm == '' && paging.prd_type == ''}">
			<li style="padding: 0; margin: 5px 30px 5px 10px;"><a href="javascript:goTypeI('', 'BestP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">판매인기순</a></li>
			<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'LowP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">낮은가격순</a></li>
			<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'HighP', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">높은가격순</a></li>
			<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'DtReg', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">등록일순</a></li>
			<li style="padding: 0; margin: 0 30px 0 0;"><a style="font-size: 13px !important;">브랜드</a>
				<ul class="dropdown">
					<li><a href="javascript:goTypeI('', '', 'YS에코비팜', '', '${paging.cd_ctg_m}');">YS에코비팜</a></li>
					<li><a href="javascript:goTypeI('', '', '나우푸드', '', '${paging.cd_ctg_m}');">나우푸드</a></li>
					<li><a href="javascript:goTypeI('', '', '나트롤', '', '${paging.cd_ctg_m}');">나트롤</a></li>
					<li><a href="javascript:goTypeI('', '', '네오셀', '', '${paging.cd_ctg_m}');">네오셀</a></li>
					<li><a href="javascript:goTypeI('', '', '네이처스웨이', '', '${paging.cd_ctg_m}');">네이처스웨이</a></li>
					<li><a href="javascript:goTypeI('', '', '노르딕내추럴스', '', '${paging.cd_ctg_m}');">노르딕내추럴스</a></li>
					<li><a href="javascript:goTypeI('', '', '뉴트렉스', '', '${paging.cd_ctg_m}');">뉴트렉스</a></li>
					<li><a href="javascript:goTypeI('', '', '블루보넷', '', $'${paging.cd_ctg_m}');">블루보넷</a></li>
					<li><a href="javascript:goTypeI('', '', '뉴트리콜로지', '', '${paging.cd_ctg_m}');">뉴트리콜로지</a></li>
					<li><a href="javascript:goTypeI('', '', '닥터스베스트', '', '${paging.cd_ctg_m}');">닥터스베스트</a></li>
				</ul>
			</li >
			<li style="padding: 0; margin: 0 30px 0 0;"><a style="font-size: 13px !important;">제품타입</a>
				<ul class="dropdown">
					<li><a href="javascript:goTypeI('', '', '', '1', '${paging.cd_ctg_m}');">액상</a></li>
					<li><a href="javascript:goTypeI('', '', '', '2', '${paging.cd_ctg_m}');">정</a></li>
					<li><a href="javascript:goTypeI('', '', '', '3', '${paging.cd_ctg_m}');">캡슐</a></li>
					<li><a href="javascript:goTypeI('', '', '', '4', '${paging.cd_ctg_m}');">베지 켑슐</a></li>
					<li><a href="javascript:goTypeI('', '', '', '5', '${paging.cd_ctg_m}');">젤리</a></li>
					<li><a href="javascript:goTypeI('', '', '', '6', '${paging.cd_ctg_m}');">분말</a></li>
					<li><a href="javascript:goTypeI('', '', '', '7', '${paging.cd_ctg_m}');">츄어볼</a></li>
				</ul>
			</li>
			</c:when>
			<c:otherwise>
				<c:if test="${paging.filter == 'BestP' && paging.corp_nm == '' && paging.prd_type == ''}">
					<li style="padding: 0; margin: 5px 30px 5px 10px;"><a href="javascript:goTypeI('', 'BestP', '', '', '${paging.cd_ctg_m}');" style="font-size: 14px !important; color: #346aff; font-weight: bold;">✔판매인기순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'LowP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">낮은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'HighP', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">높은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'DtReg', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">등록일순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a style="font-size: 13px !important;">브랜드</a>
				...
				<c:if test="${paging.filter == 'LowP' && paging.corp_nm == '' && paging.prd_type == ''}">
					<li style="padding: 0; margin: 5px 30px 5px 10px;"><a href="javascript:goTypeI('', 'BestP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">판매인기순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'LowP', '', '', '${paging.cd_ctg_m}');" style="font-size: 14px !important; color: #346aff; font-weight: bold;">✔낮은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'HighP', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">높은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'DtReg', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">등록일순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a style="font-size: 13px !important;">브랜드</a>
						<ul class="dropdown">
				...
				<c:if test="${paging.filter == 'HighP' && paging.corp_nm == '' && paging.prd_type == ''}">
					<li style="padding: 0; margin: 5px 30px 5px 10px;"><a href="javascript:goTypeI('', 'BestP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">판매인기순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'LowP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">낮은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'HighP', '','', '${paging.cd_ctg_m}');" style="font-size: 14px !important; color: #346aff; font-weight: bold;">✔높은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'DtReg', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">등록일순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a style="font-size: 13px !important;">브랜드</a>
						<ul class="dropdown">
							<li><a href="javascript:goTypeI('', '', 'YS에코비팜', '', '${paging.cd_ctg_m}');">YS에코비팜</a></li>
				...
				<c:if test="${paging.filter == 'DtReg' && paging.corp_nm == '' && paging.prd_type == ''}">
					...
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'LowP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">낮은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'HighP', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">높은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'DtReg', '','', '${paging.cd_ctg_m}');" style="font-size: 14px !important; color: #346aff; font-weight: bold;">✔등록일순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a style="font-size: 13px !important;">브랜드</a>
						<ul class="dropdown">
							<li><a href="javascript:goTypeI('', '', 'YS에코비팜', '', '${paging.cd_ctg_m}');">YS에코비팜</a></li>
							<li><a href="javascript:goTypeI('', '', '나우푸드', '', '${paging.cd_ctg_m}');">나우푸드</a></li>
				...
				<c:if test="${paging.filter == '' && paging.corp_nm != '' && paging.prd_type == ''}">
					<li style="padding: 0; margin: 5px 30px 5px 10px;"><a href="javascript:goTypeI('', 'BestP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">판매인기순</a></li>
					<li style="padding: 0; margin: 5px 30px 5px 10px;"><a href="javascript:goTypeI('', 'LowP', '', '', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">낮은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'HighP', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">높은가격순</a></li>
					<li style="padding: 0; margin: 0 30px 0 0;"><a href="javascript:goTypeI('', 'DtReg', '','', '${paging.cd_ctg_m}');" style="font-size: 13px !important;">등록일순</a></li>

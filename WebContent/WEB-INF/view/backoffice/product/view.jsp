			...
			<div class="col-md-9" style="display: flex; justify-content: center; align-items: center; margin-right: -230px;">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">상품 상세 정보</h3>
					</div>
					<!-- /.box-header -->
					...
					<div class="mailbox-controls">
						<div class="btn-group" style="display: flex; justify-content: center; gap: 10px;">
							<input type="button" value="판매중지" class="btn btn-default" style="width: 150px;"/>
							<input type="button" value="판매 재개" class="btn btn-default" style="width: 150px;"/>
							<input type="button" value="품절" class="btn btn-default" style="width: 150px;"/>
							<input type="button" value="수정" class="btn btn-default" style="width: 150px;"/>
							<input type="button" value="목록" class="btn btn-default" style="width: 150px;"/>
						</div>
					</div>
				</div>
			</div>

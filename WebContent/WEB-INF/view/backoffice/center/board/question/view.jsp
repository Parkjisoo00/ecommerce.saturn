	...
	<section class="content">
		...
		<div class="col-md-3">
			...
			<c:if test="${boardDto.seq_reply > 0}">
				<div class="col-md-8">
					<div class="box box-primary">
						...
						<div class="box-body no-padding">
							<div class="mailbox-read-info">
							<h3 style="font-size:30px; text-align:center">${boardReplyDto.title}</h3><br/><br/><br/>
							<h5 style="font-size:20px; padding: 20px 0 0 0;">작성자:Bravo My Life
								<span class="mailbox-read-time pull-right" style="font-size:18px">작성 일자:${boardReplyDto.dt_reg}</span></h5>
							</div>
							<br/>
			...
			<!-- /.box-footer -->
							<div class="box-footer">
								<div class="pull-right">
									<button type="button" class="btn btn-primary" onclick="modifyForm(3);"><i class="fa fa-pencil"></i> 수정</button>
									<button type="button" class="btn btn-default" onclick="goList(3);"><i class="fa fa-fw fa-align-justify"></i> 목록</button>
								</div>

			...
			<div class="row">
				...
				<c:choose>
					...
					<div style="text-align: center; width: 100%; margin-top: 20px; color: black !important;" >
						<a href="javascript:goWriteForm(1);" style="font-size: 15px !important; display: inline-block; padding: 10px 15px; color: black; background-color: #c7b199; border: 1px solid #cccccc; border-radius: 10px;">등록</a>
						<br>
						<br>

			...
			<div class="col-md-8">
				<div class="box box-primary">
					<div class="box-body no-padding">
						...
						${boardDto.content}
						<img src="/img/health/${boardDto.file_save}" alt="" style="margin-top: 50px;max-width: 50%;" />
						</div>
						<div class="box-footer">
							<div class="pull-right">
								<button type="button" class="btn btn-primary" onclick="modifyForm(6);"><i class="fa fa-pencil"></i> 수정</button>
								<button type="button" class="btn btn-default" onclick="goList(6);"><i class="fa fa-fw fa-align-justify"></i> 목록</button>
							</div>
							<button type="button" onclick="javascript:remove(6);" class="btn btn-default"><i class="fa fa-trash-o"></i> 삭제</button>
						</div>
					</div>
				<!-- /. box -->
				</div>

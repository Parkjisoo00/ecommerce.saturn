		...
		<div class="col-md-8">
			...
			<div class="box-body">
				...
				<div class="form-group">
						...
						<c:if test="${boardDto.file_orig != ''}">
							<a href="javascript:download('BbsIngred', ${boardDto.seq_bbs});">[첨부파일 다운로드]</a>
						</c:if>
				</div>
			</div>
			<!-- /.box-body -->
			...
			<div class="pull-right">
				<button type="button" class="btn btn-primary" onclick="modifyProc(7);"><i class="fa fa-pencil"></i> 수정</button>

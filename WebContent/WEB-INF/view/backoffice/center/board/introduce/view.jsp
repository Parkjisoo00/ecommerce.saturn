			...
			<div class="col-md-8">
				...
				<!-- /.box-header -->
					<div class="box-body no-padding">
						...
						${boardDto.content}
						<img src="/img/introduce/${boardDto.file_save}" alt="" style="margin-top: 50px;max-width: 50%;" />
						</div>
						<!-- /.mailbox-read-message -->
						<!-- /.box-footer -->
						<div class="box-footer">
							<div class="pull-right">
								<button type="button" class="btn btn-primary" onclick="modifyForm(5);"><i class="fa fa-pencil"></i> 수정</button>
								<button type="button" class="btn btn-default" onclick="goList(5);"><i class="fa fa-fw fa-align-justify"></i> 목록</button>
							</div>
							<button type="button" onclick="javascript:remove(5);" class="btn btn-default"><i class="fa fa-trash-o"></i> 삭제</button>
						</div>
					<!-- /.box-footer -->
					</div>
				<!-- /. box -->

								...
								<div class="accordion" id="accordionExample">
									<div class="card">
										...
										<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
											<div class="card-body">
												<ul>
													<li><a href="javascript:goTypeG('bld');">혈당/혈행/혈압</a></li>
													<li><a href="javascript:goTypeG('imu');">황산화/면역력</a></li>
													<li><a href="javascript:goTypeG('inf');">염증/항염</a></li>
													<li><a href="javascript:goTypeG('jnt');">관절/뼈/치아</a></li>
													<li><a href="javascript:goTypeG('rec');">피로회복</a></li>
													<li><a href="javascript:goTypeG('eye');">눈 건강</a></li>
													<li><a href="javascript:goTypeG('col');">장 건강</a></li>
													<li><a href="javascript:goTypeG('brn');">두뇌/기억력</a></li>
													<li><a href="javascript:goTypeG('stm');">위/간/갑상선</a></li>
												</ul>
											</div>
										</div>
									</div>

...
<body>
	...
	<!-- Breadcrumb Begin -->
	<ul style="position: absolute;top: ;left: 10px;transform: translateY(30px);">
				<li><a href="/front/member/modifyForm.web" class="menuLnb">개인정보 수정</a></li>
				<li><a href="#" class="menuLnb">문의 이력</a></li>
				<li><a href="#" class="menuLnb">포인트</a></li>
				<li><a href="#" class="menuLnb">맞춤건강 결과표</a></li>
				<li><a href="#" class="menuLnb">찜한 상품</a></li>
				<li><a href="#" class="menuLnb">구매이력</a></li>
				<li><a href="#" class="menuLnb">회원 탈퇴</a></li>
	</ul>
	<!-- Breadcrumb End -->

...
<form id="frmMain" method="POST">
						...
						<table class="customer-table">
							<tbody>
								...
								<tr style="border: 0;">
									...
									<td class="customer-td2">
										<input class="customer-input" type="text" style="width:100px; text-align: center; margin-right: 20px;" autocomplete="off" placeholder="포인트 입력" id="pointInput" />
								...
								<tr style="border: 0;">
									...
									<td class="customer-td3" id="finalAmountCell">
										<input type="hidden" id="finalAmountCell" value="">
									</td>
								</tr>
							</tbody>
						</table>
	...
	$(document).ready(function () {
		...
		pointInput.on('keydown', function (event) {
			...
			if (event.key === 'Enter') {
				...
				var finalPrice = totalPriceSum - inputValue;

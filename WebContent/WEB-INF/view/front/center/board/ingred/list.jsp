			...
			<div class="col-lg-12" style="padding: 0 !important;">
				<div>
					...
					<h6 class="coupon__link" style="text-align: center; letter-spacing: 1.5px; border: none">
						...
						<a href="javascript:goIngredInfo();" style="font-size: 15px !important; display: inline-block; padding: 10px 15px; color: black; background-color: #c7b199; border: 1px solid #cccccc; border-radius: 10px;">성분사전</a>
					</h6>
				</div>
			</div>
